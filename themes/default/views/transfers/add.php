                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">          
                            <div class="form-group">
                                ...
                                echo form_dropdown('biller_id', $billers,$setting->site_name, 'class="form-control" id="biller_id" placeholder="' . lang("select") . ' ' . lang("biller") . '" style="width:100%" required="required"')
                                ?>
                            </div>
                        </div>
