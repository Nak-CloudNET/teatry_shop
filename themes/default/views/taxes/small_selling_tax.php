...
<script>
    $(document).ready(function () {
        var oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('taxes/getSalesReportForSmallTaxpayers/?v=1' . $v) ?>',
            'fnServerData': function (sSource, aoData, fnCallback,nRow) {
                ...
                "bSortable": false,
                "mRender": checkbox
            },{"mRender": fld}, null, null, null,  null,{"mRender": currencyFormat},null,{"mRender": row_status_confirm}],
			...
			{column_number: 7, filter_default_label: "[<?=lang('remark');?>]", filter_type: "text", data: []},
        ], "footer");
    });
</script>
<script>
...
<div class="box">
        ...
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('salling_tax_small_tax_payers'); ?></h2>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
					  ...
					  <li>
						...
						-->
					  <li><a href="<?= site_url('taxes/small_combine_tax'); ?>" data-toggle="modal" data-target="#myModal"
...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function() {
		$('body').on('click', '#add_salllingtax', function() {
			...
			$('#myModal').modal({remote: '<?=base_url('taxes/small_combine_tax');?>?data=' + arrItems + ''});
			$('#myModal').modal('show');
		});
