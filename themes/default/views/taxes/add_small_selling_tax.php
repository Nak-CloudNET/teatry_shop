...
<div class="modal-dialog" style="width:80%;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('tax_declare'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("taxes/small_combine_tax", $attrib); ?>
			...
			<div class="table-responsive">
                <table id="CompTable" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        ...
                        <th style="width:20%;"><?= $this->lang->line("remark"); ?></th>
						<th style="width:15%;"><?= $this->lang->line("amount"); ?></th>
                        <th style="width:15%;display:none;"><?= $this->lang->line("vat"); ?></th>
                        <th style="width:15%;display:none;"><?= $this->lang->line("total_amount"); ?></th>			
                        ...
                        foreach ($combine_tax->result() as $combine_taxes) { ?>
                            <tr class="row<?= $combine_taxes->id ?>">
                                ...
                                <td class="col-xs-3" style="display:none;">
									<input type="hidden" name="pns[]" id="pns_box" class="pns form-control" value="">
...
<script type="text/javascript" charset="UTF-8">
	...
	$(".checkgns").on('ifChanged',function() {	
		var parent = $(this).parent().parent().parent();
		var pns=($(this).val());
		parent.find('#pns_box').val(pns);
		/*if($(this).is(':checked')) {
			$('.checkgns').each(function() {
				$(this).iCheck('check');
			});
		}else{
			$('.checkgns').each(function() {
