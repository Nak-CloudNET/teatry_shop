...
<div class="container" style="width: 821px;margin: 0 auto;">
    ...
    <div class="row">
            ...
            <?php } ?>
					...
					<h3 style="font-family:Times New Roman !important;font-weight:bold !important; text-align:center"><?= lang("Purchase Requese")?></h3>
            <br>
			<div class="col-lg-12">
            ...
            <div class="col-sm-12 col-xs-12">
                <table class="table table-bordered" style="width: 100%;">
					...
					<tr class="thead" style="font-size: 13px;background-color: #444 !important; color: #FFF !important;">
							<th><?= lang("no"); ?></th>
                            <th style="width:200px !important;"><?= lang("description"); ?></th> 
                            <th><?= lang("unit"); ?></th> 
                            <th><?= lang("quantity"); ?></th>
                            <?php
