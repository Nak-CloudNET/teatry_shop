...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		var clearStorage = '<?=$this->session->userdata('remove_s2');?>';
		if (clearStorage == '1') {
			...
			if (localStorage.getItem('pndate')) {
				localStorage.removeItem('pndate');
			}
			if (localStorage.getItem('pnref')) {
				localStorage.removeItem('pnref');
			}
		...
		$("#pnref").attr('readonly', 'readonly'); 
		$('#ref_st').on('ifChanged', function() {
		  if ($(this).is(':checked')) {
            $("#pnref").attr('readonly', false); 
			$("#pnref").val("");
		  }else{
			$("#pnref").prop('readonly', true);
