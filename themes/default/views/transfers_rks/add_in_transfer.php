                    ...
                    <div class="col-lg-12">
							...
							<div style="float:left;width:100%;">
								<div class="form-group">
									<div class="input-group">   
										<?php echo form_input('reference_no', $reference_no, 'class="form-control input-tip" id="poref"'); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                $post = array('completed' => lang('completed'), 'pending' => lang('pending'));
                                ...
                                <div class="controls table-controls">
                                    <table id="toTable"
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <th class="col-md-1" style="display:none;"><?= lang("net_unit_cost"); ?></th>
                                            ...
                                            <th style="display:none;"><?= lang("subtotal"); ?> (<span
