...
<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('sales/getHouseSale' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
...
<?php if ($Owner) {
	   echo form_open('sales/listSaleRoom_actions', 'id="action-form"');
	}
?>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?=site_url('pos')?>">
                                <i class="fa fa-plus-circle"></i> <?=lang('add_suspend')?>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
							<a href="#" class="bpo"
								...
								<i class="fa fa-trash-o"></i> <?=lang('delete_suspend')?>
							</a>
						</li>
                    </ul>
                </li>
                <?php if (!empty($warehouses)) {
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?=site_url('sales/suspend')?>"><i class="fa fa-building-o"></i> <?=lang('all_warehouses')?></a></li>
                            <li class="divider"></li>
                            <?php
                            	foreach ($warehouses as $warehouse) {
                            	        echo '<li><a href="' . site_url('sales/suspend/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            	    }
                                ?>
                        </ul>
                    </li>
