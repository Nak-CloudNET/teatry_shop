                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="paid_by" id="paid_by_1" class="form-control paid_by"
                                        ...
                                        <option value="gift_card" <?= (($payment->paid_by == 'gift_card')? 'selected':'') ?> ><?= lang("gift_card"); ?></option>
										<option value="deposit" <?= (($payment->paid_by == 'deposit')? 'selected':'') ?> ><?= lang("deposit"); ?></option>
