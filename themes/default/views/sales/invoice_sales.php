...
<div class="container print_rec" id="wrap">
    <div class="row">
        <div class="col-lg-12">
            <?php if (isset($biller->logo)) { ?>
			 ...
			 <?php } ?>
                <div class="col-xs-6 text-center">
                    ...
                    <h2 style="margin-top: -10px !important; margin-bottom: 0px !important"><?= lang("sales_receipt"); ?></h2>
                </div>
            ...
            <div class="row padding10" style="margin-top: -20px !important">
                <div class="col-xs-5" id="customer" style="float: left;font-size:14px; margin-top: -30px !important">
                    <table id="customer-table" style="width:400px; font-size: 12px !important">
						<tr style="border: 1px solid #000">
                            <td style="padding: 5px; width:90px !important;">
    ...
    <div id="footer" class="row" style="margin-top: 50px !important; margin: 0 !important">
        <div class="col-sm-3 col-xs-3">
            <center>
            <p style="margin-left: -55px !important;"><?= lang('receiver_kh'); ?></p>
            <hr style="border:1px solid #000; width:200px; float: left;" />
            </center>
        </div>
        <div class="col-sm-3 col-xs-3">
            <center>
            <p style="margin-left: -55px !important;"><?= lang('driver_kh'); ?></p>
            <hr style="border:1px solid #000; width:200px; float: left;" />
            </center>
        </div>
        <div class="col-sm-3 col-xs-3">
            <center>
            <p style="margin-left: -55px !important;"><?= lang('prepared_by_kh'); ?></p>
            <hr style="border:1px solid #000; width:200px; float: left;" />
            </center>
        </div>
        <div class="col-sm-3 col-xs-3">
            <center>
            <p style="margin-left: -55px !important;"><?= lang('seller_kh'); ?></p>
            <hr style="border:1px solid #000; width:200px; float: left;" />
            </center>
        </div>
    </div>
