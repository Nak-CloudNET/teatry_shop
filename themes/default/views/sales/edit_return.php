...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		localStorage.setItem('iref', '<?= $sale->reference_no ?>');
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-minus-circle"></i><?= lang('edit_return'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("sales/edit_return/" . $inv->id, $attrib)
                ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-md-4">
							<?= lang("reference_no", "reref"); ?>
							<?php echo form_input('reference_no', $inv->reference_no?$inv->reference_no:"",'class="form-control input-tip" id="reref" readonly'); ?>
						</div>
