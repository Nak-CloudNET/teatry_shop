									...
									<div style="float:left;width:100%;">
										<div class="form-group">
											<div class="input-group">  
												...
												<?php echo form_input('reference_no', ($down_info->reference_no?$down_info->reference_no:$reference),'class="form-control input-tip spref" id="reference_no" required="required"'); ?>
												<input type="hidden"  name="temp_reference_no"  id="temp_reference_no" value="<?= ($down_info->reference_no?$down_info->reference_no:$reference)?>" />
