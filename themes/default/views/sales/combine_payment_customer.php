...
$(".remove_line").on('click',function() {
    var row = $(this).closest('tr').find('.f-cus').focus();
    row.remove();
});
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("sales/combine_payment_customer", $attrib); ?>
                ...
                <table id="CompTable" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td><strong><?= $this->erp->formatDecimal($total); ?></strong></td>
