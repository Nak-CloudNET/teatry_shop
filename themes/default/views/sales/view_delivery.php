        ...
        <div class="modal-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped" style="font-size:15px;">
                    ...
                    <thead>
						<tr>
							<th <th style = "text-align:center; vertical-align:middle;"><?php echo $this->lang->line("no"); ?></th>
            ...
            <div class="btn-group btn-group-justified" id="noprint">
                ...
                <div class="btn-group">
                    <a href="<?= site_url('sale_order/delivery_note_header/' . $delivery->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('delivery_note') ?>">
                        <i class="fa fa-print"></i>
                        <span class="hidden-sm hidden-xs">DNH</span>
                    </a>
                </div>
				
				<div class="btn-group">
                    <a href="<?= site_url('sale_order/delivery_note_no_header/' . $delivery->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('delivery_note') ?>">
                        <i class="fa fa-print"></i>
                        <span class="hidden-sm hidden-xs">DNNH</span>
                    </a>
                </div>
				...
				<div class="btn-group">
                    <a href="<?= site_url('sale_order/combo_delivery_note/' . $delivery->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('tiger_invoice') ?>">
                        <i class="fa fa-print"></i>
                        <span class="hidden-sm hidden-xs"><?= lang('combo_note') ?></span>
                    </a>
                </div>
