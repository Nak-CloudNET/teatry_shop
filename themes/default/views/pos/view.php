    ...
    <head>
        ...
        <style type="text/css" media="all">
			...
			@font-face {
			 ...
			 font-style: normal;
			 font-weight: normal; 
			 src: local("Kh Metal Chrieng"), url("<?= $assets ?>/fonts/Fasthand-Regular.ttf") format("truetype");
			}
    ...
    <div id="receipt-data">
        <div class="text-center">
			...
			<?php } else { ?>				
				...
				<h3><strong>ទៀ  ទ្រី II</strong></h3>
			<?php } ?>
			<?php
			...
			<tr style="display:none;">
				...
				?>
						...
						<tr>
							<th style="border-left:2px solid #000;border-top:2px solid #000;border-right:none;padding-right: 12px;width:64%;"  class="text-left">Received (USD) :</th>
							<th style="border-right:2px solid #000;border-top:2px solid #000;border-left:none;" class="text-left"><?= $this->erp->formatMoney($payment->pos_paid); ?></th>
						</tr>
						<?php
							if($inv->other_cur_paid){
						?>
						<tr>
							<th style="border-left:2px solid #000;border-bottom:2px solid #000;padding-right: 12px;width:64%;"  class="text-left">Received (Riel) :</th>
							<th style="border-bottom:2px solid #000;border-right:2px solid #000;border-left:none;" class="text-left"><?= $inv->other_cur_paid . '  ៛' ; ?></th>
						</tr>
						<?php
							}
						?>
            ...
            ?>
			<br/>
			<?= $biller->invoice_footer ? '<p class="text-center"><strong>'. $this->erp->decode_html($biller->invoice_footer) . '</strong></p>' : ''; ?>
