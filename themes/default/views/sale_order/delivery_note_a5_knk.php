                    ...
                    <tbody style="font-size: 13px;">
                       ...
                       <?php foreach($inv_items as $inv_item) { ?>
                            <?php
								...
								$cal_qty = $inv_item->qty * $inv_item->qty_unit;
                            ?>
							<tr>
                                ...
                                <td style="vertical-align:middle;width:15%;border-top:none !important;border-bottom:none !important;" class="text-center" >
                                    <?= $this->erp->formatMoney($inv_item->qty).''.($str_unit != $inv_item->unit?'( '.$str_unit.')':'') ?>
                                </td>
								 <td style="vertical-align:middle;width:15%;border-top:none !important;border-bottom:none !important;" class="text-center" >
                                    <?= $this->erp->formatMoney($cal_qty).'('.$inv_item->unit.')' ?>
                                </td>
