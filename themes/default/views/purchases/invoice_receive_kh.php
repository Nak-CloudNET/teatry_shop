    ...
    <div class="row">
        <div class="col-lg-12">
            <?php if ($logo) { ?>
                ...
                <div class="col-xs-6 text-center" style="text-align:center !important;">
                    <h1><strong><?= $billers->company;?></strong></h1>
                    <p><?= $billers->address ?></p>
                    ...
                    <h2><strong>ប័ណ្ណទទួលទំនិញ</strong></h2>
                </div>
                <div class="col-xs-3">
            ...
            <div class="row padding10">
                <div class="col-xs-5" style="float: left;font-size:14px">
                    <h4 style="font-family: Times New Roman"><b><?= lang("supplier"); ?></b></h4>
                    <table>
						<tr>
                            <td>
                                <p><?= "<b>".lang("code")."</b>";?></p>
                        ...
                        <tr>
                            ...
                            <td>
								<p><strong><?= $supplier->name_kh ? $supplier->name_kh : $supplier->name; ?></strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div class="col-xs-5 td_ref"  style="float: right !important; font-size:14px; padding-left: 150px !important;">
                    <h4 style="font-family: Times New Roman"><b><?= lang("reference");?></b></h4>
                    <table>
                        <tr>
                            <td>
                                <p><?= "<b>".lang("delivery_no")."</b>"; ?></p>
                            </td>
                            <td>
                                <p>&nbsp;:&nbsp;</p>
                            </td>
                ...
                <table class="table table-bordered table-hover table-striped" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; font-weight:bold;"><?= lang("ចំនួនសរុប"); ?>
            ...
            <div class="row">
                    ...
                    <div class="col-lg-2 col-xs-4">
                        <p class="bold"><?= lang("អ្នកដឹកជញ្ជូន"); ?></p>
                        <br><br>
                        <p style="border-bottom: 1px solid #666;">&nbsp;</p>
                        <p><?= lang("name"); ?> :  ........................................</p>
                        <p><?= lang("date"); ?> :  ......../......./.........</p>
                    ...
                    <div class="col-lg-3"></div>
                    <div class="col-lg-2 col-xs-4">
                        <p class="bold"><?= lang("អ្នកកាន់ស្តុក"); ?></p>
                        <br><br>
                        <p style="border-bottom: 1px solid #666;">&nbsp;</p>
                        <p><?= lang("name"); ?> :  ........................................</p>
                        <p><?= lang("date"); ?> :  ......../......./.........</p>
