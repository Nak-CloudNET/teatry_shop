...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('supplier_opening_balance'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("purchases/supplier_opening_balance", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-md-12">
                            ...
                            <div class="well well-sm">
                                <a href="<?php echo $this->config->base_url(); ?>assets/csv/supplier_opening_balance.csv"
