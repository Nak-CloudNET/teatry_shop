...
<body>
	<div class="container" style="width: 821px;margin: 0 auto;">
		...
		<div class="col-xs-12">
			<div class="row">
				<div class="col-sm-3 col-xs-3 text-center" style="margin-bottom:15px;">
                    <img style="width:130px" src="<?= base_url() . 'assets/uploads/logos/' . $biller->logo; ?>" alt="">
				</div>
				<div class="col-sm-12 col-xs-12 inv text-center" style="margin-top: -150px;">
                    ...
                    ?>
					<hr>
					<h4><strong style="margin-left: 40px !important;">Supplier Balance</strong></h4>
                </div>
			</div>
				...
				<div class="col-sm-7 col-xs-7">
					<div class="box1">
						<table style="font-size: 13px;line-height:22px !important;">
							<tr>
								<td style="width: 10%;">ក្រុមហ៊ុន</td>
								<td style="width: 3%;">:</td>
								<td style="width: 50%;"><?= $supplier->company; ?></td>
							</tr>
							<tr>
								<td style="width: 10%;">ឈ្មោះអ្នកផ្គតផ្គង់</td>
								<td style="width: 3%;">:</td>
							...
							<tr>
								...
								<td style="width: 3%;">:</td>
								<td style="width: 50%;"><?= $supplier->phone; ?></td>
							</tr>
							<tr>
								<td style="width: 10%;">អាស័យដ្ឋាន</td>
								<td style="width: 3%;">:</td>
								<td style="width: 50%;"><?= $supplier->address; ?></td>
							</tr>
						</table>
					</div>
				</div>
				<div class="col-sm-5 col-xs-5 pull-right">
					<div class="box2">
						<table style="font-size: 13px;line-height:25px !important;">
							...
							<tr>
								<td class="td_saler" style="width: 30%;">អ្នកបង្កើត</td>
								<td style="width: 5%;text-align:right !important;">:</td>
								<td style="width: 50%;padding-left:10px !important;"><?= $created_by->username; ?></td>
							</tr>
						</table>
					</div>
				</div>
		...
		<div style="width: 821px;margin: 20px">
			<a class="btn btn-warning no-print" href="<?= site_url('sales/supplier_balance'); ?>" style="border-radius: 0">
