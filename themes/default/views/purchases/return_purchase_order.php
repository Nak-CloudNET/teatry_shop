    ...
    function loadItems() {
        ...
        if (localStorage.getItem('reitems')) {
            ...
            $.each(reitems, function () {
                ...
                tr_html += '<td class="text-right"><span class="text-right ssubtotal" id="subtotal_' + row_no + '">' + formatMoney(((parseFloat(unit_cost) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) + '</span></td>';
                ...
                total += formatDecimal(((parseFloat(unit_cost) + parseFloat(pr_tax_val)) * parseFloat(item_qty)));
                            ...
                            <div class="row" id="extras-con" style="display: none;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" style="margin-bottom:5px;">
                                        ...
                                        <?php echo form_input('shipping', number_format($inv->shipping), 'class="form-control input-tip" id="poshipping"'); ?>
