...
<head>
    ...
    <style type="text/css">
		body{
			...
			font-family:Khmer OS Moul !important;
		}
		.container {
			width: 29.7cm;
			margin: 20px auto;
    ...
    <div class="row">
            <?php if ($logo) { ?>
                ...
                <div class="col-xs-9 col-sm-9" id="shopinfo">
					...
					<h2 style=" font-family:Times New Roman !important;font-weight:bold !important;text-align:center !important;margin-right:170px !important;font-size:23px !important;"><?= $inv->company;?></h2>
            ...
            <?php } ?>
					...
					<h3 style="font-family:Times New Roman !important;font-weight:bold !important; text-align:center"><?= lang("Purchase Order")?></h3>
            <br>
			<div class="col-lg-12">
            ...
            <div class="col-sm-12 col-xs-12">
                <table class="table table-bordered" style="width: 100%;">
					...
					<tr class="thead" style="font-size: 13px;background-color: #444 !important; color: #FFF !important;">
							<th><?= lang("no"); ?></th>
                            <th style="width:180px !important;"><?= lang("description"); ?></th> 
                            <th style="width:80px !important;"><?= lang("unit"); ?></th> 
                            <th style="width:80px !important;"><?= lang("quantity"); ?></th>
                            <?php
