...
<script>
    $(document).ready(function () {
        var oTable = $('#POData').dataTable({
			...
			"bStateSave": true,
            'sAjaxSource': '<?=site_url('purchases/getPurchaseOrderAlerts' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
			...
			{column_number: 3, filter_default_label: "[<?=lang('PR_no');?>]", filter_type: "text", data: []},
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                       <?php if ($Owner || $Admin || $GP['purchases_order-add']) {?>
						   <li>
								<a href="<?=site_url('purchases/add_purchase_order')?>">
            ...
            <?php } ?>
                <?php if (!empty($warehouses)) {
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?=site_url('purchases/purchase_order')?>"><i class="fa fa-building-o"></i> <?=lang('all_warehouses')?></a></li>
                            <li class="divider"></li>
                            <?php
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <?php echo form_open("purchases/purchase_order"); ?>
                        <div class="row">
                        <div class="col-sm-4">
