<script type="text/javascript">
    ...
    $(document).ready(function () {
            ...
            select: function (event, ui) {
                ...
                if (ui.item.id !== 0) {
					...
					rows = "<tr>"
							...
							+ "<td class='text-center'><input type='hidden' value='"+ formatMoney(ui.item.cost) +"' class='from_cost'/><span class='unit_cost_raw'>"+ formatMoney(ui.item.cost) +"</span></td>"
		...
		$(document).on('change', '.total_cost_raw',function(){
			alert('he');
		});
	});
</script>
