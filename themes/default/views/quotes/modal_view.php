        ...
        <div class="modal-body">
            ...
            <div class="row" style="margin-bottom:15px;">
                <div class="col-xs-6">
                    ...
                    <?php
                    echo ($biller->address ? $biller->address . "<br>" : ''). ($biller->city ? $biller->city . " " . $biller->postal_code . " " . $biller->state . "<br>" : '') . ($biller->country ? $biller->country : '');
                    ...
                    // echo "</p>";
                    echo ($biller->phone ? '<br>'.lang("tel") . ": " . $biller->phone : '') .($biller->email ? '<br>'.lang("email") . ": " . $biller->email : '');
                    ?>
                </div>
                <div class="col-xs-6">
