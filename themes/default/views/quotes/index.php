...
<script>
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
			...
			'sAjaxSource': '<?=site_url('quotes/getQuotes' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                var authorize = aData[9];
				var issue_status = aData[8];
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld},null, null, null, null, null, {"mRender": currencyFormat},  {"mRender": row_status}/* , {"mRender": currencyFormat} */,{"mRender": authorize_status},{"bSortable": false}]
        }).fnSetFilteringDelay().dtFilter([
            {column_number: 1, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
            {column_number: 2, filter_default_label: "[<?=lang('reference_no');?>]", filter_type: "text", data: []},
            {column_number: 3, filter_default_label: "[<?=lang('po');?>]", filter_type: "text", data: []},
            ...
            {column_number: 8, filter_default_label: "[<?=lang('issue_status');?>]", filter_type: "text", data: []},
            ...
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <div class="row">
						...
						<div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="po"><?= lang("po"); ?></label>
                                <?php echo form_input('po', (isset($_POST['po']) ? $_POST['po'] : ""), 'class="form-control tip" id="po"'); ?>
