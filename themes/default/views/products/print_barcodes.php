            ...
            <div class="col-lg-12">
                ...
                <div class="well well-sm no-print">
                    ...
                    <div class="controls table-controls">
                        ...
                        <div class="form-group">
                            <?= lang('style', 'style'); ?>
                            <?php $opts = array('' => lang('select').' '.lang('style'), 40 => lang('TEA TRY II'), 18 => lang('TEA TRY II - (A4 - 18 Labels per sheet)'), 540 => lang('TEA TRY II - (A5 - 40 Labels per sheet)')); ?>
                    ...
                    <?php
                        if ($this->input->post('print')) {
                            if (!empty($barcodes)) {
								...
								$c = 1;
                                if ($style == 12 || $style == 24 || $style == 40 || $style == 8){
                                    echo '<div class="barcodea4">';
									echo '<div id="contain" style="width:100%">';
                                }elseif ($style == 18) {
                                    echo '<div class="barcodeA4_18">';
                                }elseif ($style == 540) {
                                    echo '<div class="barcodeA5_40">';
                                }elseif($style == 16){
                                ...
                                foreach ($barcodes as $item) {
                                    ...
                                    for ($r = 1; $r <= $item['quantity']; $r++) {
                                        ...
                                        if($style == 6) {
                                            ...
                                            if($item['name']) {
                                                echo '<span class="barcode_name" style="font-size:12px;padding-left:20px;">'.$item['name'].'</span>';
                                            }
                                            if($item['unit']) {
                                            ...
                                            echo '<div class="top_site">';
                                            if($item['site']) {
                                                echo '<span class="barcode_site 123" style="font-size:12px">'.$item['site'].'</span>';
                                            }
                                            if($item['name']) {
                                            ...
                                            echo '<div class="middle_site">';
                                            echo '<span class="barcode_image" style="margin-top: -7px;">';
    										echo $item['barcode'];
    										echo '<span style="float:left !important; margin-top:3px !important;">'. $item['code'] .'</span>';
                                            echo '</div>';

                                            echo '<div class="bottom_site">';
                                            if($item['price']) {
                                                echo '<span class="barcode_price">'.lang('$').' ';
                                                if($item['currencies']) {
                                            ...
                                            echo '<span style="float:left !important; margin-top:3px !important;">'. $item['code'] .'</span>';
                                            if($item['price']) {
                                                echo '<span class="barcode_price" style="margin-top:5px;font-weight:bold; font-size:15px !important; display:block; padding-top:2 !important;margin-bottom:9px; position: absolute; right:0; bottom:0">'.lang('$').' ';
                                                if($item['currencies']) {
                                                    foreach ($currencies as $currency) {
                                                        echo $currency->code . ': ' . $this->erp->formatMoney($item['price'] * $currency->rate).', ';
                                                    }
                                        ...
                                        if ($style == 40) {
                                            ...
                                            if ($c % 18 == 0) {
                                                echo '</div><div class="clearfix"></div><div class="barcodeA4_18">';
                                            }
                                        } elseif ($style == 540) {
                                            if ($c % 40 == 0) {
                                                echo '</div><div class="clearfix"></div><div class="barcodeA5_40">';
                                            }
                                        } elseif ($style == 30) {
                                            if ($c % 30 == 0) {
