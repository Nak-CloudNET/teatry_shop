            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
					...
					<div class="row" id="extras-con" style="display: none;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?php
									...
									echo form_dropdown('cf1', $ht, (isset($_POST['cf1']) ? $_POST['cf1'] : ($product ? $product->cf1 : '')), 'class="form-control" id="cf1" placeholder="' . lang("select") . " " . lang("home_type") . '" style="width:100%"')
								?>
                            </div>
                        </div>
						...
						<div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('contruction_status', 'cf7') ?>
                                <?php
									$con_st = array(""=>"","not_contruct"=>"Not Contruct","inprogress_contruct"=>"Inprogress Contruct","completed_contruct"=>"Completed Contruct"); 
									echo form_dropdown('contruction_status', $con_st, $product->contruction_status, 'class="form-control" id="contruction_status" placeholder="' . lang("select") . " " . lang("contruction_status") . '" style="width:100%"')
								?>
                            </div>
                        </div>
