<?php
	//$this->erp->print_arrays($positions);
	$v = "";
					...
					<div class="col-md-4">
						...
						<div class="form-group all">
                            ...
                            <?php
								...
								echo form_dropdown('from_location', $wh, $purchase->warehouse_id, 'class="form-control"   required  id="from_location" placeholder="' . lang("select") . ' ' . lang("location") . '" style="width:100%"')
                            ?>
                        </div>
					</div>
					<div class="col-md-4">
									...
									foreach($items as $item){
										echo '<tr>';
											echo '<td style="width:25%;">';
												echo '<input type="text"  name="item_code_and_name[]" required id="add_item" class=" form-control add_item" value="('.$item->code.')'.$item->name.'">';
												echo '<input type="hidden"  name="item_code[]" id="item_code" class=" form-control item_code" value="'.$item->code.'">';
												echo '<input type="hidden"  name="cost[]" id="cost" class=" form-control cost" value="'.$item->cost.'">';
												echo '<input type="hidden"  name="total_cost[]" id="total_cost" class=" form-control total_cost" value="'.$item->total_cost.'">';
												echo '<input type="hidden"  name="wh_id[]" id="wh_id" class=" form-control wh_id" value="">';
											echo '</td>';
											echo '<td><input type="text"  name="exp_catid[]" id="exp_catid" class="checknb form-control categories_exp" value=""></td>';
											echo '<td><input type="text"  name="description[]" id="description" class="checknb form-control description" value=""></td>';
											echo '<td><input type="text"  name="reason[]" id="s4" class="checknb form-control reason" value=""></td>';
											echo '<td class="qqh">'.$this->erp->formatQuantity($item->quantity).'</td>';
											echo '<td><input type="text"  name="qty_use[]" required id="qty_use" class="checknb form-control qty_use" value=""></td>';
											echo '<td><div class="form-group">';
												echo '<select class="form-control input-tip unit" name="unit[]" style="width:100%;">';
													echo '<option value="'.$item->unit .'">'.$item->uname .'</option>';
												echo '</select>'; 
											echo '</div></td>';
											echo '<td style="text-align:center;"><span class="btn_delete" style="cursor:pointer;"><i class="fa fa-trash-o" style="font-size: 15px; color:#2A79B9;"></i></span></td>';
										echo '</tr>';
									}
								}
							?>
		...
		$('.add_row').click(function() {
			...
			var row = '<tr>'+
				...
				'<td><select name="exp_catid[]" id="exp_catid" style="padding-top: 2px !important;" class="form-control">'+
					...
					<?php foreach ($getExpense as $exps) : ?>
				...
				'<td>'
					'<div class="form-group">';
				row+='<select class="form-control input-tip select unit" name="unit[]" style="width:100%; padding-top: 2px !important;"></select>'; 
				row+='</div>'+
				'</td>'+
