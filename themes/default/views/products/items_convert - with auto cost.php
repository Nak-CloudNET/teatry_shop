            ...
            select: function (event, ui) {
                ...
                if (ui.item.id !== 0) {
                	...
                	rows = "<tr>"
							...
							+ "<td><span class='cost_raw text-center'>"+ ui.item.cost +"</span></td>"
							+ "<td><span class='total_raw text-center'></span></td>"
            ...
            select: function (event, ui) {
                ...
                if (ui.item.id !== 0) {
                	...
                	rows = "<tr>"
							...
							+ "<td><span class='cost_finish text-center'></span></td>"
							+ "<td><span class='total_finish text-center'></span></td>"
	        				+ '<td><i style="cursor:pointer;" title="Remove" id="1449892339552" class="fa fa-times tip pointer sldel"></i></td>'
						+ "</tr>";
            ...
            for(var i=0; i < data.length; i++){
                if(data[i].row.status == 'deduct'){
                    ...
                    rows = "<tr>"
						...
						+ "<td><span class='cost_raw text-center'>"+ formatMoney(data[i].row.cost) +"</span></td>"
						+ "<td><span class='total_raw text-center'>"+ formatMoney(data[i].row.cost * qty_deduct) +"</span></td>"
                        + '<td><i style="cursor:pointer;" title="Remove" id="1449892339552" class="fa fa-times tip pointer sldel"></i></td>'
						+ "</tr>";
                    ...
                    rows = "<tr>"
                        ...
                        + data[i].row.product_name+" ("+ data[i].row.product_code +")</td>"
                        + "<td>" + (opt.get(0).outerHTML) + "</td>"
						+ "<td><span class='qoh_finish text-center'>"+ (data[i].row.qoh == undefined ? 0 : formatQuantity(data[i].row.qoh)) +"</span></td>"
						...
						+ "<td><span class='cost_finish text-center'>"+ formatMoney(data[i].row.cost) +"</span></td>"
						+ "<td><span class='total_finish text-center'>"+ formatMoney(data[i].row.cost * qty_add) +"</span></td>"
                        + '<td><i style="cursor:pointer;" title="Remove" id="1449892339552" class="fa fa-times tip pointer sldel"></i></td>'
                    + "</tr>";
