...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('customer', '<?= $adjustment->customer_id; ?>');
                    ...
                    <div class="col-lg-12">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $adjustment->biller_id), 'id="slbiller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="form-control input-tip select" style="width:100%; pointer-events: none; "');
								?>
							</div>
						</div>
