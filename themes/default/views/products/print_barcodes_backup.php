<link href="<?= $assets ?>styles/helpers/print.css" rel="stylesheet"/>
<div class="box">
                            ...
                            if (!empty($barcodes)) {
                                ...
                                foreach ($barcodes as $item) {
                                    for ($r = 1; $r <= $item['quantity']; $r++) {
                                        ...
                                        if($item['image']) {
                                            echo '<span class="product_image" style="height:100%"><img  style="width:101px;height:102px" src="'.base_url('assets/uploads/thumbs/'.$item['image']).'" alt="" /></span>';
                                        }
                                        if($item['site']) {
                                        ...
                                        if($item['price']) {
                                            echo '<span class="barcode_price" style="font-weight:bold; font-size:18px; display:block; padding-top:5px;">'.lang('$').' ';
                                            if($item['currencies']) {
