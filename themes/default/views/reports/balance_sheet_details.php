					...
					<?php
						...
						if($this->uri->segment(7)){
							...
							foreach($dataAsset->result() as $row){
								...
								$assetDetails = $this->accounts_model->getBalanceSheetDetailByAccCode($row->account_code, '10,11',$from_date,$end_dates,$biller_id);
						...
						?>
							...
							foreach($dataEquity->result() as $rowequity){
								...
								$eqDetails = $this->accounts_model->getBalanceSheetDetailByAccCode($rowequity->account_code, '30',$from_date,$end_dates,$biller_id);
