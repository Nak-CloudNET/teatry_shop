...
<div class="tab-content">
	...
	<div id="top-purchase_expend-con" class="tab-s fade in">
		<?php
			$v4 = "&supplier=" . $user_id;

			if ($this->input->post('discription')) {
				$v4 .= "&discription=" . $this->input->post('discription');
			}
			if ($this->input->post('reference_no')) {
				$v4 .= "&reference_no=" . $this->input->post('reference_no');
			}
		...
		<script>
			$(document).ready(function () {
				...
				var oTable = $('#tPRDataEx').dataTable({
					...
					{column_number: 1, filter_default_label: "[<?=lang('date');?>]", filter_type: "text", data: []},
					{column_number: 2, filter_default_label: "[<?=lang('reference_no');?>]", filter_type: "text", data: []},
					{column_number: 3, filter_default_label: "[<?=lang('discription');?>]", filter_type: "text", data: []},
				], "footer");
			});
		</script>
		<script type="text/javascript">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div id="productforms2">
							...
							<?php echo form_open("reports/supplier_report/".$user_id."/#top-purchase_expend-con"); ?>
								<div class="row">
									<div class="col-sm-4">
									<div class="form-group">
										<label class="control-label" for="reference_no"><?= lang("reference_no"); ?></label>
									...
									<!--<div class="col-sm-4">
										<div class="form-group">
											<label class="control-label" for="cat"><?= lang("discription"); ?></label>
											<?php
											
											echo form_input('discription', (isset($_POST['discription']) ? $_POST['discription'] : ""), 'class="form-control tip" id="discription"'); 
											?>
										</div>
									</div>-->
