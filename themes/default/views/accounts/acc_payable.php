...
<script>
    $(document).ready(function () {
        var oTable = $('#POData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('purchases/getpending_Purchases' . ($warehouse_id ? '/' . $warehouse_id : '/0').($dt ? '/' . $dt : '')).'/?v=1'.$v?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-star"></i><?=lang('list_ac_payable') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';?>
        </h2>
		<div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <?php echo form_open("account/list_ac_payable"); ?>
                                        <div class="row">
                        <div class="col-sm-4">
