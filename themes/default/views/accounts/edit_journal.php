		...
		<div class="row">
			...
			?>
				...
				<div class="col-md-12 journal-list">
					...
					<div class="col-md-2">
						<div class="form-group margin-b-5">	
							<?php echo form_input('debit[]', $this->erp->formatDecimal($journal->debit), 'class="form-control debit'. $n .' number_only" id="debit"'); ?>
						</div>
					</div>
					
					<div class="col-md-2">
						<div class="form-group margin-b-5">
							<?php echo form_input('credit[]', $this->erp->formatDecimal($journal->credit), 'class="form-control credit'.$n .' number_only" id="credit"'); ?>
						</div>
					</div>
					<div class="col-md-1">
						<div class="form-group margin-b-5">
