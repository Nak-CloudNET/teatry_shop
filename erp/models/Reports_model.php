...
*/
   ...
   public function getCustomersByID($id=null, $wh=null) {
	...
	public function getQtyByWare($pid,$wid,$product2,$category2,$start,$end,$biller, $expiry, $wid1){
	...
	public function getAllProductsDetails($pid, $cid, $per_page, $ob_set, $from_date, $to_date)
	{
