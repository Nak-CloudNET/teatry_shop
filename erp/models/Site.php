...
class Site extends CI_Model
{
	...
	{
		$this->db
				->select("sales.id, sales.date, sales.reference_no, sales.biller, sales.biller_id, companies.company as customer, companies.phone as phone, sales.customer_id as customer_id, sales.saleman_by as saleman_by, sales.sale_status, sales.grand_total, sales.paid, (grand_total-paid) as balance, sales.payment_status")
				->from('sales')
