...
class Sale_order extends MY_Controller
{
    ...
    function delivery_invoice($id = NULL)
    {
		...
		$this->data['po'] = $this->sale_order_model->getPOById($inv->sale_id, $inv->type);
	...
	function delivery_note_header($id = NULL)
    {
        ...
        $this->data['title'] = "2";
        $this->data['sid'] = $id;
        $this->load->view($this->theme.'sale_order/delivery_note_header',$this->data);
    }
	
	function delivery_note_no_header($id = NULL)
    {
        ...
        $this->data['title'] = "2";
        $this->data['sid'] = $id;
        $this->load->view($this->theme.'sale_order/delivery_note_no_header',$this->data);
    }
	
	function combo_delivery_note($id = NULL)
    {
        ...
        $this->data['title'] = "2";
        $this->data['sid'] = $id;
        $this->load->view($this->theme.'sale_order/combo_delivery_note',$this->data);
    }
